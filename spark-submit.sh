...
spark-submit  --master spark://rakshit-thesis.cloud.ut.ee:7077 --conf spark.eventLog.enabled=false ws/outlier-detection/main.py --estimator decision_tree
...
spark-submit  --master spark://rakshit-thesis.cloud.ut.ee:7077  ws/outlier-detection/main.py --estimator random_forest
spark-submit  --master spark://rakshit-thesis.cloud.ut.ee:7077 --num-executors 5 --executor-cores 3 --archives pyspark_venv.tar.gz  ws/outlier-detection/main.py --estimator random_forest
spark-submit  --master spark://rakshit-thesis.cloud.ut.ee:7077 ws/outlier-detection/main.py --estimator perceptron
