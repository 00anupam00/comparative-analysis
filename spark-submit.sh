...
# spark-submit  --master spark://rakshit-thesisv2.cloud.ut.ee:7077 comparative-analysis/main.py --estimator decision_tree --mode binary > logs/without_pca/binary/output-$(date +'%b-%d-%Y-%H:%M:%S').txt
# spark-submit  --master spark://rakshit-thesisv2.cloud.ut.ee:7077 comparative-analysis/main.py --estimator decision_tree --mode multiclass > logs/without_pca/multiclass/output-$(date +'%b-%d-%Y-%H:%M:%S').txt

# spark-submit  --master spark://rakshit-thesisv2.cloud.ut.ee:7077  comparative-analysis/main.py --estimator random_forest --mode binary > logs/without_pca/binary/output-$(date +'%b-%d-%Y-%H:%M:%S').txt
#  spark-submit  --master spark://rakshit-thesisv2.cloud.ut.ee:7077  comparative-analysis/main.py --estimator random_forest --mode multiclass > logs/without_pca/multiclass/output-$(date +'%b-%d-%Y-%H:%M:%S').txt

# spark-submit  --master spark://rakshit-thesisv2.cloud.ut.ee:7077 comparative-analysis/main.py --estimator perceptron --mode multiclass > logs/without_pca/multiclass/output-$(date +'%b-%d-%Y-%H:%M:%S').txt
